...
class Provider:
    ...
    def renderTile(self, width, height, srs, coord):
        ...
        tolerance = self.simplify * \
            tolerances[coord.zoom] if coord.zoom < self.simplify_until else None
...
class Response:
    ...
    def __init__(self, dbinfo, srid, subquery, columns, bounds, tolerance, zoom, clip):
        ...
        geo_query = build_query(srid, subquery, columns, bbox, tolerance, zoom, True, clip)
        merc_query = build_query(srid, subquery, columns, bbox, tolerance, zoom, False, clip)
...
def build_query(srid, subquery, subcolumns, bbox, tolerance, zoom, is_geo, is_clipped):
